        ...
        <div className='project-card'>
          <div className='row'>
            ...
            <div className='col-md-4'>
              <img src={bookImg} className="mx-auto d-block expence-icon" alt="test" />
            </div>
            <div className='col-md-8'>
              ...
              <h4 className='mt-2 text-center'> 📝 Track, manage, and control your expenses effortlessly !</h4>
          ...
          <a href='https://expenes-stracker.vercel.app/' target='blank'>
              ...
              <a href='https://github.com/lakshmankolpe/expenes_stracker' target='blank'>
      ...
      <div className='container mt-2 mb-5'>
        <div className='project-card'>
          <div className='row'>
            ...
            <div className='col-md-4'>
              <img src={chalkTalk} className="mx-auto d-block short-link-icon" alt="test"/>
            </div>
            <div className='col-md-8'>
              ...
              <h4 className='mt-2 text-center'>Save time and simplify sharing by converting long URLs into short, easy-to-share links effortlessly.
          ...
          <a href='https://shortify-murex.vercel.app/' target='blank'>
              ...
              <a href='https://github.com/lakshmankolpe/Shortify' target='blank'>
                <button className='btn-code m-3 p-2'><b><i class="fab fa-github-square"></i> Source Code</b></button>
              </a>
          </div>
